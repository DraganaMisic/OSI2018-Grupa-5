...
int izvlacenje(int *niz1,int *niz2,int ukupnoBodova)     //funkcija koja ispisuje na standardni izlaz i izracunava bodove
{
    int i,j;
    int br=0,k=10,bodovi=0,brojac=0;
    for( i=0; i<20; i++)
    {
        if(ukupnoBodova>100 &&ukupnoBodova<200)
            generisanje_novog_broja(niz1,niz2,i,4,br);
        if(ukupnoBodova>200 &&ukupnoBodova<300)
            generisanje_novog_broja(niz1,niz2,i,3,br);
        if(ukupnoBodova>300)
            generisanje_novog_broja(niz1,niz2,i,2,br);
    brojac++;
...
void generisanje_novog_broja(int *niz1,int *niz2,int i,int dozvoljeno,int pogodjeno)    //generisanje  brojeva u odnosu na broj bodova
{
    if(dozvoljeno==pogodjeno)
    {
        int m=0;
        do
        {
